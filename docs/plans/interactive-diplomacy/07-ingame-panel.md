...
| 7.04 | [04-wiring.md](07-ingame-panel/04-wiring.md) | Live conversation through `runChatTurn` with a game streaming sink, deal-action error consolidation and extraction into shared actions, enactment, and notifications on replies (with observer targeting). |

...
7. In a pure-observer game, the unchanged mock demo plays exactly as in normal play — Converse and chat available, Propose Deal and the active proposal actions interactive, settled cards view-only — while the own speaker renders as Observer and Declare War is absent.

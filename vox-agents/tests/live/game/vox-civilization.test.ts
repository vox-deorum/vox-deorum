...
// TEST_TIER. Without it we skip the whole suite, so a stray run (e.g. pointing vitest
// straight at this file) can never launch or kill a real Civilization V process.
const liveGameEnabled = process.env.TEST_TIER === 'live/game';

describe.skipIf(!liveGameEnabled)('VoxCivilization Integration Test', () => {
